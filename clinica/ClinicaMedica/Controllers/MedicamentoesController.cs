...
namespace ClinicaMedica.Controllers
{
    ...
    public class MedicamentoesController : Controller
    {
        ...
        public MedicamentoesController(ClinicaMedicaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MedicamentoId,Nombre,Precio,Stock")] Medicamento medicamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicamentoId,Nombre,Precio,Stock")] Medicamento medicamento)
        {
